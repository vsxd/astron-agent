// com.iflytek.astron.console.hub.config.thread.AsyncExecutorConfig
package com.iflytek.astron.console.hub.config.thread;

import com.iflytek.astron.console.hub.config.properties.AsyncExecutorProperties;
