...
import com.iflytek.astron.console.hub.dto.user.JwtInfoDto;
...
public class JwtClaimsFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (authentication != null && authentication.getPrincipal() instanceof Jwt jwt) {
            ...
            request.setAttribute(RequestContextUtil.USER_ID_ATTRIBUTE, userId);
            ...
            request.setAttribute(RequestContextUtil.USER_INFO_ATTRIBUTE, userInfo);
        }
