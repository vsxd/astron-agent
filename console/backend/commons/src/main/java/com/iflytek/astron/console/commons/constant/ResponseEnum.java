...
public enum ResponseEnum {
    ...
    DATABASE_IMPORT_PARTIAL_FAILED(8914, "database.import.partial.failed"),

    // Evaluation task 9000 - 9200
    EVALTASK_SCENE_CANNOT_EMPTY(9000, "evaltask.scene.cannot.empty"),
    EVALTASK_SCENE_NAME_EXIST(9001, "evaltask.scene.name.exist"),
    EVALTASK_SCENE_NOT_EXIST(9002, "evaltask.scene.not.exist"),
    EVALTASK_SCENE_CANNOT_MODIFY_OFFICIAL(9003, "evaltask.scene.cannot.modify.official"),
    EVALTASK_SCENE_CANNOT_DELETE_DIMENSION_EXIST(9004, "evaltask.scene.cannot.delete.dimension.exist"),
    EVALTASK_SCENE_CANNOT_DELETE_OFFICIAL(9005, "evaltask.scene.cannot.delete.official"),
    EVALTASK_DIMENSION_NAME_CANNOT_EMPTY(9006, "evaltask.dimension.name.cannot.empty"),
    EVALTASK_DIMENSION_NAME_EXIST(9007, "evaltask.dimension.name.exist"),
    EVALTASK_DIMENSION_NOT_EXIST(9008, "evaltask.dimension.not.exist"),
    EVALTASK_DIMENSION_CANNOT_MODIFY_OFFICIAL(9009, "evaltask.dimension.cannot.modify.official"),
    EVALTASK_DIMENSION_CANNOT_DELETE_OFFICIAL(9010, "evaltask.dimension.cannot.delete.official"),
    EVALTASK_DIMENSION_TEMPLATE_EXPORT_FAILED(9011, "evaltask.dimension.template.export.failed"),
    EVALTASK_NEED_UPLOAD_FILE(9012, "evaltask.need.upload.file"),
    EVALTASK_XLSX_SUPPORT_ONLY(9013, "evaltask.xlsx.support.only"),
    EVALTASK_STRING_LIMITED_50(9014, "evaltask.string.limited.50"),
    EVALTASK_EXCEL_LACK_HEAD(9015, "evaltask.excel.lack.head"),
    EVALTASK_EXCEL_LACK_ROW(9016, "evaltask.excel.lack.row"),
    EVALTASK_EXCEL_HEAD_NOT_MATCH(9017, "evaltask.excel.head.not.match"),
    EVALTASK_DATASET_TEMPLATE_GEN_FAILED(9018, "evaltask.dataset.template.gen.failed"),
    EVALTASK_EXCEL_NEED_HEAD_MUST(9019, "evaltask.excel.need.head.must"),
    EVALTASK_EXCEL_NOT_EMPTY_MUST(9020, "evaltask.excel.not.empty.must"),
    EVALTASK_EXCEL_QUESTION_EMPTY(9021, "evaltask.excel.question.empty"),
    EVALTASK_BOT_NOT_EXIST(9022, "evaltask.bot.not.exist"),
    EVALTASK_WORKFLOW_NOT_EXIST(9023, "evaltask.workflow.not.exist"),
    EVALTASK_TASK_NAME_CANNOT_EMPTY(9024, "evaltask.task.name.cannot.empty"),
    EVALTASK_TASK_NAME_SAME(9025, "evaltask.task.name.same"),
    EVALTASK_APPID_TYPE_MUST(9026, "evaltask.appid.type.must"),
    EVALTASK_NO_AUTHED_MODEL(9027, "evaltask.no.authed.model"),
    EVALTASK_GET_AKSK_FAILED(9028, "evaltask.get.aksk.failed"),
    EVALTASK_NO_FUNCTION_CALL_INFO(9029, "evaltask.no.function.call.info"),
    EVALTASK_NO_YITU_INFO(9030, "evaltask.no.yitu.info"),
    EVALTASK_BIANLIANG_NOT_SUPPORTED(9031, "evaltask.bianliang.not.supported"),
    EVALTASK_NO_MARK_INFO(9032, "evaltask.no.mark.info"),
    EVALTASK_AGENT_NOT_SUPPORTED(9033, "evaltask.agent.not.supported"),
    EVALTASK_NO_NODE_INFO(9034, "evaltask.no.node.info"),
    EVALTASK_LLM_JSON_NOT_SUPPORTED(9035, "evaltask.llm.json.not.supported"),
    EVALTASK_EXCEL_SECOND_HEAD_LACK(9036, "evaltask.excel.second.head.lack"),
    EVALTASK_DATASET_NAME_SAME(9037, "evaltask.dataset.name.same"),
    EVALTASK_NO_WORKFLOW(9038, "evaltask.no.workflow"),
    EVALTASK_WORKFLOW_PROTOCOL_EMPTY(9039, "evaltask.workflow.protocol.empty"),
    EVALTASK_ID_LIST_CANNOT_EMPTY(9040, "evaltask.id.list.cannot.empty"),
    EVALTASK_NO_DATASET_REPORT(9041, "evaltask.no.dataset.report"),
    EVALTASK_NO_DATASET_SID_DATA(9042, "evaltask.no.dataset.sid.data"),
    EVALTASK_OFFLINE_PARAM_MISS(9043, "evaltask.offline.param.miss"),
    EVALTASK_ILLEGAL_EVAL_MODE_PARAM(9044, "evaltask.illegal.eval.mode.param"),
    EVALTASK_DATASET_EMPTY_OFFLINE(9045, "evaltask.dataset.empty.offline"),
    EVALTASK_DATASET_EMPTY_ONLINE(9046, "evaltask.dataset.empty.online"),
    EVALTASK_TASK_EXISTED(9047, "evaltask.task.existed"),
    EVALTASK_TASK_AGAIN_FAILED(9048, "evaltask.task.again.failed"),
    EVALTASK_DATASET_DISPLAY_FAILED(9049, "evaltask.dataset.display.failed"),
    EVALTASK_TASK_STATUS_UNFINISHED(9050, "evaltask.task.status.unfinished"),
    EVALTASK_TASK_MODE_DOUBLE(9051, "evaltask.task.mode.double"),
    EVALTASK_TASK_NEW_FAILED(9052, "evaltask.task.new.failed"),
    EVALTASK_STATUS_QUERY_FAILED_STOP(9053, "evaltask.status.query.failed.stop"),
    EVALTASK_FINE_TUNING_EXITED_IN_TASK(9054, "evaltask.fine.tuning.exited.in.task"),
    EVALTASK_TASK_NOT_SUPPORT_EXCEPT_WORKFLOW(9055, "evaltask.task.not.support.except.workflow"),
    EVALTASK_DATASET_ID_NOT_INPUT(9056, "evaltask.dataset.id.not.input"),
    EVALTASK_NODE_NOT_INPUT(9057, "evaltask.node.not.input"),
    EVALTASK_FT_MODEL_NOT_INPUT(9058, "evaltask.ft.model.not.input"),
    EVALTASK_DATASET_NAME_EXISTED(9059, "evaltask.dataset.name.existed"),
    EVALTASK_CHECKED_DATA_EMPTY(9060, "evaltask.checked.data.empty"),
    EVALTASK_NOT_QUERY_BS_INFO(9061, "evaltask.not.query.bs.info"),
    EVALTASK_AGENT_YH_TASK_NOT_SUPPORTED(9062, "evaltask.agent.yh.task.not.supported"),
    EVALTASK_PARSE_INPUT_PARAM_TYPE_FAILED(9063, "evaltask.parse.input.param.type.failed"),
    EVALTASK_PAGE_SEPARATOR_MISS(9064, "evaltask.page.separator.miss"),
    EVALTASK_EXCEL_NEED_HEAD_NUM(9065, "evaltask.excel.need.head.num"),
    EVALTASK_STATUS_QUERY(9066, "evaltask.status.query"),

    // User/Group 9200 - 9300
    USER_GROUP_GET_USER_INFO_FAILED(9200, "user.group.get.user.info.failed"),
    USER_GROUP_TAG_CANNOT_EMPTY(9201, "user.group.tag.cannot.empty"),
    USER_GROUP_TAG_EXIST(9202, "user.group.tag.exist"),
    USER_NAME_CANNOT_EMPTY(9203, "user.name.cannot.empty"),
    USER_NOT_FOUND_SPECIFIED(9204, "user.not.found.specified"),
    USER_NAME_EXIST_MULTIPLE(9205, "user.name.exist.multiple"),
    USER_CANNOT_ADD_SELF(9206, "user.cannot.add.self"),
    USER_CANNOT_ADD_REPEAT(9207, "user.cannot.add.repeat"),
    USER_LIST_EMPTY(9208, "user.list.empty"),
    USER_TAG_RELATE_EMPTY(9209, "user.tag.relate.empty"),
    USER_UID_CANNOT_EMPTY(9210, "user.uid.cannot.empty"),
    USER_TAG_ID_CANNOT_EMPTY(9211, "user.tag.id.cannot.empty"),

    // Common toolkit errors 9300 - 9400
    TOOLKIT_INTERNAL_SERVER_ERROR(9300, "toolkit.internal.server.error"),
    TOOLKIT_BAD_REQUEST(9301, "toolkit.bad.request"),
    TOOLKIT_USER_AUTH_FAILED(9302, "toolkit.user.auth.failed"),
    TOOLKIT_FAILED_CLOUD_ID(9303, "toolkit.failed.cloud.id"),
    TOOLKIT_FAILED_MCP_REG(9304, "toolkit.failed.mcp.reg"),
    TOOLKIT_NON_SERVICE_FAIL(9305, "toolkit.non.service.fail"),
    TOOLKIT_EXCEED_AUTHORITY(9306, "toolkit.exceed.authority"),
    TOOLKIT_UNSUPPORTED_OPERATION(9307, "toolkit.unsupported.operation"),
    TOOLKIT_DATA_NOT_EXIST(9308, "toolkit.data.not.exist"),
    TOOLKIT_FAILED_TOOL_CALL(9309, "toolkit.failed.tool.call"),
    TOOLKIT_FAILED_MCP_GET_DETAIL(9310, "toolkit.failed.mcp.get.detail"),
    TOOLKIT_FAILED_AUTH(9311, "toolkit.failed.auth"),
    TOOLKIT_FAILED_GENERATE_SERVER_URL(9312, "toolkit.failed.generate.server.url"),
    TOOLKIT_CHANNEL_DOMAIN_CANNOT_NULL_BOTH(9313, "toolkit.channel.domain.cannot.null.both"),
    TOOLKIT_CHANNEL_CANNOT_NULL(9314, "toolkit.channel.cannot.null"),
    TOOLKIT_PATCH_ID_CANNOT_NULL(9315, "toolkit.patch.id.cannot.null"),
    TOOLKIT_FLOW_PROTOCOL_EMPTY(9316, "toolkit.flow.protocol.empty"),
    TOOLKIT_FLOW_ANS_MODE_ILLEGAL(9317, "toolkit.flow.ans.mode.illegal"),
    TOOLKIT_NOT_BE_EMPTY(9318, "toolkit.not.be.empty"),
    TOOLKIT_UNSUPPORTED_FILE_FORMAT(9319, "toolkit.unsupported.file.format"),
    TOOLKIT_FAILED_GET_FILE_TYPE(9320, "toolkit.failed.get.file.type"),
    TOOLKIT_VERSION_EXISTED(9321, "toolkit.version.existed"),
    TOOLKIT_INVALID_TYPE(9322, "toolkit.invalid.type"),
    TOOLKIT_FAILED_EXPORT(9323, "toolkit.failed.export"),
    TOOLKIT_NOT_CUSTOM_MODEL(9324, "toolkit.not.custom.model"),
    TOOLKIT_DELIMITER_SAME(9325, "toolkit.delimiter.same"),
    TOOLKIT_APPID_CANNOT_EMPTY(9326, "toolkit.appid.cannot.empty"),
    TOOLKIT_NOT_GET_UID(9327, "toolkit.not.get.uid"),
    TOOLKIT_FAILED_GET_TRACE(9328, "toolkit.failed.get.trace"),
    TOOLKIT_OPERATION_FAILED(9329, "toolkit.operation.failed"),
    TOOLKIT_INFO_MISS(9330, "toolkit.info.miss"),
    TOOLKIT_APPID_MISS(9331, "toolkit.appid.miss"),
    TOOLKIT_ID_EMPTY(9332, "toolkit.id.empty"),
    TOOLKIT_PARAM_MISS(9333, "toolkit.param.miss"),
    TOOLKIT_NO_INPUT_ANY_DATA(9334, "toolkit.no.input.any.data"),
    TOOLKIT_PARAM_ERROR(9335, "toolkit.param.error"),
    TOOLKIT_STREAM_PROTOCOL_EMPTY(9336, "toolkit.stream.protocol.empty"),
    TOOLKIT_FILTER_CONF_MISS(9337, "toolkit.filter.conf.miss"),
    TOOLKIT_PROTOCOL_EMPTY(9338, "toolkit.protocol.empty"),
    TOOLKIT_FILE_EMPTY(9339, "toolkit.file.empty"),
    TOOLKIT_FILE_EXTENSION(9340, "toolkit.file.extension"),
    TOOLKIT_FILE_UPLOAD_FAILED(9341, "toolkit.file.upload.failed"),
    TOOLKIT_UPLOADED_BUSINESS_NOT_SUPPORT(9342, "toolkit.uploaded.business.not.support"),
    TOOLKIT_PASSWORD_ERROR(9343, "toolkit.password.error"),

    // Common errors 9400 - 9500
    COMMON_AUDIT_FAILED(9400, "common.audit.failed"),
    COMMON_EMAIL_SEND_FAILED(9401, "common.email.send.failed"),
    COMMON_GENERATE_PIC_FAILED(9402, "common.generate.pic.failed"),
    COMMON_NO_RECORD(9403, "common.no.record"),
